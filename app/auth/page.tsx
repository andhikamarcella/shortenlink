    ...
    <main className="min-h-screen flex items-center justify-center bg-neutral-900 text-white px-4">
      <div className="w-full max-w-sm rounded-xl bg-neutral-800 p-6 shadow-lg ring-1 ring-white/10">
        ...
        <button
          ...
          disabled={isPending}
          className="mt-6 w-full rounded-lg bg-white/90 px-4 py-2 text-sm font-medium text-neutral-900 transition hover:bg-white disabled:cursor-not-allowed disabled:opacity-60"
        >
        ...
        <p className="mt-8 text-[10px] text-center leading-relaxed text-neutral-500">
